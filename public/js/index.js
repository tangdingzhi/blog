...
S.UI = (function () {
  var ui = document.querySelector('.ui'),
      input = document.querySelector('.ui-input'),
      ...
      maxShapeSize = 30,
      firstAction = true,
      sequence = ["春风十里","五十里","一百里","体测八百米","海底两万里","德芙巧克力","香草味八喜","可可布朗尼","榴莲菠萝蜜","芝士玉米粒","鸡汁土豆泥","黑椒牛里脊","黄焖辣子鸡","红烧排骨酱醋鱼","不如你","全都不如你","To","亲爱的你","可爱的小姐姐","💋程梦竹"],
      cmd = '#';
